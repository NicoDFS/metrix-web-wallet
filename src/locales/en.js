export default {
  ...
  create_token: {
    ...
    name: 'Token Name',
    symbol: 'Token Symbol',
    decimal: 'Decimals (It\'s recommended to set decimals to 8 in MRX)',
  ...
  restore_key_file: {
    ...
    password_title: 'Please input your password to decrypt the wallet',
  },
  restore_ledger: {
    ...
    download: 'No Metrix APP? Please install it follow this https://www.ledgerwallet.com/apps/manager',
    connect: 'CONNECT',
  },
  view: {
